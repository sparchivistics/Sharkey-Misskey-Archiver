...
\`\`\`  
sharkey\_archive\_instance.social\_noteId123.zip  
...
└── archive\_data/            \# Created on first run  
    ├── archive.db           \# SQLite database  
    └── media/               \# Downloaded media files  
        └── instance.social\_noteId/  
            ├── fileId1.jpg  
            ├── fileId2.mp4  
            └── screenshot.png  
\`\`\`
...
\- \`instance\`, \`note\_id\`, \`url\`  
\- \`user\_name\`, \`user\_handle\`, \`user\_avatar\`  
\- \`content\`, \`cw\` (content warning)  
\- \`created\_at\`, \`archived\_at\`  
\- \`reply\_count\`, \`renote\_count\`, \`reaction\_count\`  
\- \`visibility\`, \`raw\_json\`, \`screenshot\_path\`

\*\*media table:\*\*  
\- \`id\`, \`post\_id\` (foreign key)  
\- \`filename\`, \`url\`, \`mime\_type\`, \`local\_path\`  
\- \`width\`, \`height\`, \`is\_sensitive\`, \`alt\_text\`
